...
void constructupperpath_sbcpc(differentialpath& path, uint32 dm[16], uint32 diffihv[4])
{
	...
	while (true) {
                ...
                m4 = xrng64();
		HASHUTIL5_MD5COMPRESS_STEP(md5_ii, a, b, c, d, m4, 0xf7537e82,  6);
		HASHUTIL5_MD5COMPRESS_STEP(md5_ii, a2, b2, c2, d2, m4+dm[4], 0xf7537e82,  6);
		if (a2-a != diffihv[0]) {
		...
		m11 = xrng64(); 
                HASHUTIL5_MD5COMPRESS_STEP(md5_ii, d, a, b, c, m11, 0xbd3af235, 10);
                HASHUTIL5_MD5COMPRESS_STEP(md5_ii, d2, a2, b2, c2, m11+dm[11], 0xbd3af235, 10);
		if (d2-d != diffihv[3]) {
			b = xrng64(); c = xrng64();
			continue;
		}
		m2 = xrng64(); 
                HASHUTIL5_MD5COMPRESS_STEP(md5_ii, c, d, a, b, m2, 0x2ad7d2bb, 15);
                HASHUTIL5_MD5COMPRESS_STEP(md5_ii, c2, d2, a2, b2, m2+dm[2], 0x2ad7d2bb, 15);
		if (c2-c != diffihv[2]) {
			b = xrng64();
			continue;
		}
		m9 = xrng64(); 
                HASHUTIL5_MD5COMPRESS_STEP(md5_ii, b, c, d, a, m9, 0xeb86d391, 21);
                HASHUTIL5_MD5COMPRESS_STEP(md5_ii, b2, c2, d2, a2, m9+dm[9], 0xeb86d391, 21);
