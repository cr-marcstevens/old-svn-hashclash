...
#ifndef HASHUTIL5_TYPES_HPP
#define HASHUTIL5_TYPES_HPP
...
namespace boost {
	namespace serialization {
		...
		void serialize(Archive& ar, hashutil::triple<Ty1,Ty2,Ty3>& t, const unsigned int file_version)
		{
