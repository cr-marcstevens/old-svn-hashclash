...
#ifndef HASHUTIL5_CONDITIONS_HPP
#define HASHUTIL5_CONDITIONS_HPP
...
namespace boost {
	namespace serialization {
		...
		void serialize(Archive& ar, hashutil::byteconditions& b, const unsigned int file_version)
		{
			ar & make_nvp("val", b.val);
		}

		template<class Archive>
		void serialize(Archive& ar, hashutil::wordconditions& w, const unsigned int file_version)
		{
...
#endif //HASHUTIL5_CONDITIONS_HPP
