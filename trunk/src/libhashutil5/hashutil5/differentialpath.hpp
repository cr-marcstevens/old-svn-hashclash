...
#ifndef HASHUTIL5_DIFFERENTIALPATH_HPP
#define HASHUTIL5_DIFFERENTIALPATH_HPP
...
namespace boost {
	namespace serialization {
		...
		void serialize(Archive& ar, hashutil::differentialpath& p, const unsigned int file_version)
		{			
...
#endif //HASHUTIL5_DIFFERENTIALPATH_HPP
