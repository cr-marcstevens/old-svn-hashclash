...
#ifndef HASHUTIL5_SHA1MESSAGESPACE_HPP
#define HASHUTIL5_SHA1MESSAGESPACE_HPP
...
namespace boost {
	namespace serialization {
		...
		void serialize(Archive& ar, hashutil::sha1messagespace& s, const unsigned int file_version)
		{			
...
#endif //HASHUTIL5_SHA1MESSAGESPACE_HPP
