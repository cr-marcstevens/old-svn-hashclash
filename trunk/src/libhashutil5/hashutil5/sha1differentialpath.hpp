...
#ifndef HASHUTIL5_SHA1DIFFERENTIALPATH_HPP
#define HASHUTIL5_SHA1DIFFERENTIALPATH_HPP
...
namespace boost {
	namespace serialization {
		...
		template<class Archive>
		void serialize(Archive& ar, hashutil::sha1differentialpath& p, const unsigned int file_version)
		{			
...
#endif //HASHUTIL5_SHA1DIFFERENTIALPATH_HPP
